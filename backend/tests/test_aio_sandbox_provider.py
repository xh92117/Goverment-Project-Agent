...
# 鈹€鈹€ ensure_thread_dirs 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
# 鈹€鈹€ _get_thread_mounts 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
def test_join_host_path_preserves_windows_drive_letter_style():
    base = r"C:\Users\demo\agent-base\backend\.agent-base"

    joined = join_host_path(base, "threads", "thread-9", "user-data", "outputs")

    assert joined == r"C:\Users\demo\agent-base\backend\.agent-base\threads\thread-9\user-data\outputs"
...
def test_get_thread_mounts_preserves_windows_host_path_style(tmp_path, monkeypatch):
    ...
    aio_mod = importlib.import_module("deerflow.community.aio_sandbox.aio_sandbox_provider")
    monkeypatch.setenv("DEER_FLOW_HOST_BASE_DIR", r"C:\Users\demo\agent-base\backend\.agent-base")
    monkeypatch.setattr(aio_mod, "get_paths", lambda: Paths(base_dir=tmp_path))
    monkeypatch.setattr(aio_mod, "get_effective_user_id", lambda: None)
    ...
    assert container_paths["/mnt/user-data/workspace"] == r"C:\Users\demo\agent-base\backend\.agent-base\threads\thread-10\user-data\workspace"
    assert container_paths["/mnt/user-data/uploads"] == r"C:\Users\demo\agent-base\backend\.agent-base\threads\thread-10\user-data\uploads"
    assert container_paths["/mnt/user-data/outputs"] == r"C:\Users\demo\agent-base\backend\.agent-base\threads\thread-10\user-data\outputs"
    assert container_paths["/mnt/acp-workspace"] == r"C:\Users\demo\agent-base\backend\.agent-base\threads\thread-10\acp-workspace"


def test_skills_mount_prefers_agent_base_host_skills_path(tmp_path, monkeypatch):
    aio_mod = importlib.import_module("deerflow.community.aio_sandbox.aio_sandbox_provider")
    skills_dir = tmp_path / "skills"
    skills_dir.mkdir()
    config = SimpleNamespace(skills=SimpleNamespace(get_skills_path=lambda: skills_dir, container_path="/mnt/skills"))
    monkeypatch.setattr(aio_mod, "get_app_config", lambda: config)
    monkeypatch.setenv("AGENT_BASE_HOST_SKILLS_PATH", "/host/agent-skills")
    monkeypatch.setenv("DEER_FLOW_HOST_SKILLS_PATH", "/host/legacy-skills")

    assert aio_mod.AioSandboxProvider._get_skills_mount() == ("/host/agent-skills", "/mnt/skills", True)


def test_skills_mount_keeps_legacy_host_skills_path_fallback(tmp_path, monkeypatch):
    aio_mod = importlib.import_module("deerflow.community.aio_sandbox.aio_sandbox_provider")
    skills_dir = tmp_path / "skills"
    skills_dir.mkdir()
    config = SimpleNamespace(skills=SimpleNamespace(get_skills_path=lambda: skills_dir, container_path="/mnt/skills"))
    monkeypatch.setattr(aio_mod, "get_app_config", lambda: config)
    monkeypatch.delenv("AGENT_BASE_HOST_SKILLS_PATH", raising=False)
    monkeypatch.setenv("DEER_FLOW_HOST_SKILLS_PATH", "/host/legacy-skills")

    assert aio_mod.AioSandboxProvider._get_skills_mount() == ("/host/legacy-skills", "/mnt/skills", True)
...
# 鈹€鈹€ Sandbox client teardown (#2872) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
