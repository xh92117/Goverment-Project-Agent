...
def isolated_cwd(tmp_path, monkeypatch):
    ...
    monkeypatch.delenv("AGENT_BASE_CONFIG_PATH", raising=False)
...
def test_resolve_extras_agent_base_config_path_overrides_legacy(tmp_path, monkeypatch):
    monkeypatch.delenv("UV_EXTRAS", raising=False)
    agent_config = tmp_path / "agent.yaml"
    legacy_config = tmp_path / "legacy.yaml"
    agent_config.write_text("database:\n  backend: postgres\n")
