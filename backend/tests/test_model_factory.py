...
def test_provider_metadata_is_not_forwarded_to_openai_compatible_client(monkeypatch):
    """Settings-page provider metadata must not become an API request kwarg."""
    ...
    factory_module.create_chat_model(name="qwen-vision")
