...
reconciliation end-to-end 鈥?that logic is covered by unit tests in
...
E2E_PREFIX = "agent-base-sandbox-e2e-test"
...
class TestOrphanReconciliationE2E:
    ...
    def test_orphan_container_destroyed_on_startup(self):
        ...
        3. Call list_running() 鈫?should find the container
        4. Simulate _reconcile_orphans() logic 鈫?container should be destroyed
        """
        ...
        try:
            ...
            # Step 4: Simulate reconciliation 鈥?this container's created_at is recent,
    ...
    def test_list_running_ignores_unrelated_containers(self):
        ...
        try:
            ...
            # "unrelated-test-container" doesn't match "agent-base-sandbox-e2e-test-" prefix
            for info in running:
