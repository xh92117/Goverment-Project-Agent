...
Legacy upstream issue #3144: gateway request dependencies resolve
...
STARTUP_ONLY_FIELDS: dict[str, str] = {
    ...
    # config.yaml edits.
    "channels": ("start_channel_service() is invoked once during startup; the live IM channel clients (DingTalk, WeChat, WeCom, Feishu) are not rebuilt when channels.* changes."),
}
