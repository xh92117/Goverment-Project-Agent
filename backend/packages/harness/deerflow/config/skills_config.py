...
class SkillsConfig(BaseModel):
    ...
    def get_skills_path(self) -> Path:
        ...
        Resolution order:
            ...
            2. ``AGENT_BASE_SKILLS_PATH`` environment variable
            3. Legacy ``DEER_FLOW_SKILLS_PATH`` environment variable
        ...
        if env_path := os.getenv("AGENT_BASE_SKILLS_PATH") or os.getenv("DEER_FLOW_SKILLS_PATH"):
