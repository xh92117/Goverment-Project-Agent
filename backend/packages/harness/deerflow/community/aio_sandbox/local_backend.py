...
SANDBOX_HOST_ENV = "AGENT_BASE_SANDBOX_HOST"
LEGACY_SANDBOX_HOST_ENV = "DEER_FLOW_SANDBOX_HOST"
SANDBOX_BIND_HOST_ENV = "AGENT_BASE_SANDBOX_BIND_HOST"
LEGACY_SANDBOX_BIND_HOST_ENV = "DEER_FLOW_SANDBOX_BIND_HOST"


def _get_env_with_legacy(primary_key: str, legacy_key: str, default: str | None = None) -> str | None:
...
def _resolve_docker_bind_host(sandbox_host: str | None = None, bind_host: str | None = None) -> str:
    ...
    narrower bind with ``AGENT_BASE_SANDBOX_BIND_HOST``.  When operators choose
    ...
    explicit_bind = (
        ...
        else _get_env_with_legacy(SANDBOX_BIND_HOST_ENV, LEGACY_SANDBOX_BIND_HOST_ENV)
    )
    ...
    host = (
        ...
        else _get_env_with_legacy(SANDBOX_HOST_ENV, LEGACY_SANDBOX_HOST_ENV, "localhost")
    )
...
class LocalContainerBackend(SandboxBackend):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            container_prefix: Prefix for container names (e.g., "agent-base-sandbox").
    ...
    # 鈹€鈹€ SandboxBackend interface 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    def create(self, thread_id: str | None, sandbox_id: str, extra_mounts: list[tuple[str, str, bool]] | None = None) -> SandboxInfo:
        ...
        sandbox_host = _get_env_with_legacy(SANDBOX_HOST_ENV, LEGACY_SANDBOX_HOST_ENV, "localhost")
        return SandboxInfo(
    ...
    def list_running(self) -> list[SandboxInfo]:
        ...
        # Step 2: batched docker inspect 鈥?single subprocess call for all containers
    ...
    # 鈹€鈹€ Container operations 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    def _is_container_running(self, container_name: str) -> bool:
        ...
        This enables cross-process container discovery 鈥?any process can detect
