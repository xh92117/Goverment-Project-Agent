"""Summarization middleware extensions for Agent Base."""
...
class AgentBaseSummarizationMiddleware(SummarizationMiddleware):
...
# Backward-compatible import name for existing downstream code and historical
# stream keys. New runtime construction should use AgentBaseSummarizationMiddleware.
DeerFlowSummarizationMiddleware = AgentBaseSummarizationMiddleware
