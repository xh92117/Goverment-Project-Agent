...
INTERNAL_AUTH_HEADER_NAME = "X-Agent-Base-Internal-Token"
LEGACY_INTERNAL_AUTH_HEADER_NAME = "X-DeerFlow-Internal-Token"
INTERNAL_AUTH_ENV_VAR = "AGENT_BASE_INTERNAL_AUTH_TOKEN"
LEGACY_INTERNAL_AUTH_ENV_VAR = "DEER_FLOW_INTERNAL_AUTH_TOKEN"
INTERNAL_SYSTEM_ROLE = "internal"
INTERNAL_USER_ID = "default"


def _load_internal_auth_token() -> str:
    token = os.environ.get(INTERNAL_AUTH_ENV_VAR) or os.environ.get(LEGACY_INTERNAL_AUTH_ENV_VAR)
    if token:
        return token
...
def get_internal_user():
    ...
    return SimpleNamespace(id=INTERNAL_USER_ID, system_role=INTERNAL_SYSTEM_ROLE)
