...
_CHANNELS_LANGGRAPH_URL_ENV = "AGENT_BASE_CHANNELS_LANGGRAPH_URL"
_LEGACY_CHANNELS_LANGGRAPH_URL_ENV = "DEER_FLOW_CHANNELS_LANGGRAPH_URL"
_CHANNELS_GATEWAY_URL_ENV = "AGENT_BASE_CHANNELS_GATEWAY_URL"
_LEGACY_CHANNELS_GATEWAY_URL_ENV = "DEER_FLOW_CHANNELS_GATEWAY_URL"


def _resolve_service_url(config: dict[str, Any], config_key: str, env_key: str, legacy_env_key: str, default: str) -> str:
    value = config.pop(config_key, None)
    if isinstance(value, str) and value.strip():
        return value
    env_value = (os.getenv(env_key) or os.getenv(legacy_env_key) or "").strip()
    if env_value:
        return env_value
    return default
...
class ChannelService:
    ...
    def __init__(self, channels_config: dict[str, Any] | None = None) -> None:
        ...
        langgraph_url = _resolve_service_url(config, "langgraph_url", _CHANNELS_LANGGRAPH_URL_ENV, _LEGACY_CHANNELS_LANGGRAPH_URL_ENV, DEFAULT_LANGGRAPH_URL)
        gateway_url = _resolve_service_url(config, "gateway_url", _CHANNELS_GATEWAY_URL_ENV, _LEGACY_CHANNELS_GATEWAY_URL_ENV, DEFAULT_GATEWAY_URL)
