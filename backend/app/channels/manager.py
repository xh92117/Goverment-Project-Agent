"""ChannelManager consumes inbound messages and dispatches them to the Agent Base runtime via Gateway."""
...
class ChannelManager:
    """Core dispatcher that bridges IM channels to the Agent Base runtime.
    ...
    async def _handle_chat(self, msg: InboundMessage, extra_context: dict[str, Any] | None = None) -> None:
        ...
        # Look up existing Agent Base thread.
        # topic_id may be None for single-thread-per-chat channel modes — the store
