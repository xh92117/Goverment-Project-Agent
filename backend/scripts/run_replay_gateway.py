...
def _is_test_seed_enabled() -> bool:
    return os.environ.get("AGENT_BASE_ENABLE_TEST_SEED") == "1" or os.environ.get("DEERFLOW_ENABLE_TEST_SEED") == "1"
