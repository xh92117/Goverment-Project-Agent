...
This document describes how to use and maintain Agent Base backend blocking-IO
...
```text
.agent-base/blocking-io-findings.json
```
...
Keeping rules centralized makes it clear which extra primitives Agent Base
