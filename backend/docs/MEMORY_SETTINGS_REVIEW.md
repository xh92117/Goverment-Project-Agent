...
1. Start Agent Base locally using any working development setup you already use.
   ...
   If you already have Agent Base running locally, you can reuse that existing setup.
...
- Default local runtime target: `backend/.agent-base/memory.json`
