 ...
 * + AGENT_BASE_RECORD_OUT in the environment — never run in CI.
 *
  ...
  webServer: [
    {
      ...
      env: {
        ...
        ...(process.env.AGENT_BASE_RECORD_OUT || process.env.DEERFLOW_RECORD_OUT
          ? {
              AGENT_BASE_RECORD_OUT:
                process.env.AGENT_BASE_RECORD_OUT ??
    ...
    },
    {
      ...
      env: {
        ...
        AGENT_BASE_INTERNAL_GATEWAY_BASE_URL: "http://127.0.0.1:8012",
