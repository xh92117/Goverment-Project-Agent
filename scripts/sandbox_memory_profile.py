#!/usr/bin/env python3
"""Collect Kubernetes sandbox pod memory snapshots for Agent Base.
...
DEFAULT_NAMESPACE = "agent-base"
DEFAULT_SELECTOR = "app=agent-base-sandbox"
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        "# Agent Base Sandbox Memory Profile",
        "",
